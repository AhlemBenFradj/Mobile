...
public class ServiceRegimes {
    ...
    public boolean addRegimes(Regimes t) {
        String url = Statics.BASE_URL + "/JSON/Add_Reg?Titre=" + t.getTitre() + "&Description=" + t.getDescription()+ "&ImgUml=" + t.getImgUml(); //création de l'URL
    ...
    public ArrayList<Regimes> getAllRegimes(){
        String url = Statics.BASE_URL+"/JSON/List_Reg";
