...
public class ServiceRepas {
    ...
    public boolean addRepas(Repas t) {
        String url = Statics.BASE_URL1 + "/JSON/Add_Rep?Titre=" + t.getTitre() + "&Description=" + t.getDescription()+ "&ImgUml=" + t.getImgUml(); //création de l'URL
    ...
    public ArrayList<Repas> getAllRepas(){
        String url = Statics.BASE_URL1+"/JSON/List_Rep";
